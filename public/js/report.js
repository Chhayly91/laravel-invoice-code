            ...
            success: function ($result) {
                if ($result != "") {
                    ...
                    $.each($result, function (index, val) {
                        ...
                        tr +=
                            '<td class="filter_total">' +
                            val.grand_total +
                            "</td>";
                        tr +=
                            '<td class="text-center">\n' +
                            '     <a href="/order/list/view/' +
                            val.id +
                            '" class="btn btn-success btn-circle"><i class="far fa-eye"></i></a>\n' +
                            '     <a href="/order/list/print/' +
                            val.id +
                            '" class="btn btn-secondary btn-circle"><i class="fas fa-print"></i></a>\n' +
                            " </td>";
                        tr += "</tr>";
